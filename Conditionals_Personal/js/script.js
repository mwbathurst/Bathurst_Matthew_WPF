...
I will also create variables so that a user with specific dietary goals in terms of protein can change for personal settings.
*/
...
var myProteinPerLb = 1.5; // This is a variable that is customizable for the user
